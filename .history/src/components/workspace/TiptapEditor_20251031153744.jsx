      ...
      <div className="tiptap-editor border border-gray-300 rounded-lg overflow-hidden">
        ...
        <div className="bg-gradient-to-b from-gray-50 to-white border-b border-gray-200">
          ...
          <div className="flex items-center justify-between px-2 py-1 border-b border-gray-100">
            ...
            >
              <span className="text-base">{isToolbarExpanded ? "▼" : "▶"}</span>
            ...
            <div className="flex flex-wrap gap-1.5 p-2.5">
              ...
              <div className="flex flex-wrap gap-1 items-center">
                ...
                <button
                  ...
                  className={`w-8 h-8 rounded flex items-center justify-center font-semibold text-xs transition-all ${
                ...
                <button
                  ...
                  className={`w-8 h-8 rounded flex items-center justify-center italic text-xs transition-all ${
