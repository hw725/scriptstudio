    ...
    <div className="h-full flex flex-col bg-white relative">
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          ...
          <DropdownMenu>
            ...
            >
              ...
              >
                <span>현재 줄 강조</span>
                <span className={`ml-2 text-primary ${enableLineHighlight ? "" : "opacity-0"}`}>
                  ✓
                </span>
              </DropdownMenuItem>
              <DropdownMenuItem
              ...
              >
                <span>줄무늬</span>
                <span className={`ml-2 text-primary ${enableZebraStripes ? "" : "opacity-0"}`}>
                  ✓
                </span>
              </DropdownMenuItem>
            </DropdownMenuContent>
      ...
      <div className="flex-1 flex min-h-0">
        ...
        {showVersionHistory ? (
          ...
          {/* 태그 오른쪽의 행 스타일 드롭다운은 제거하여 상단 메뉴로 통합 */}
      {!onEnterTranslationMode && (
        <PomoFlowPanel
          note={note}
