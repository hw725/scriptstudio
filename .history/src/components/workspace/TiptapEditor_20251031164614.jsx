...
const TiptapEditor = forwardRef(
  (
    ...
    return (
      <div className="tiptap-editor border border-gray-300 rounded-lg overflow-hidden">
        {/* 툴바 (항상 컴팩트) */}
        <div className="flex flex-wrap gap-0.5 p-1.5 bg-gradient-to-b from-gray-50 to-white border-b border-gray-200">
          {/* 텍스트 서식 */}
          <button
          ...
          {editor.isActive("table") && (
            <>
              ...
              <button
                ...
                className={`w-7 h-7 text-xs rounded bg-white hover:bg-gray-100 text-xs`}
                title="Delete Table"
              >
                {"✕"}
              </button>
