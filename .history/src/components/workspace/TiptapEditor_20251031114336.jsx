...
const TiptapEditor = ({ content = '', onChange, placeholder = '노트를 작성하세요...' }) => {
    ...
    <div className="tiptap-editor border border-gray-300 rounded-lg overflow-hidden">
      ...
      <div className="flex flex-wrap gap-1 p-2 bg-gray-50 border-b border-gray-300">
        ...
        <button
          ...
          className={`px-3 py-1 rounded ${
            editor.isActive('strike') ? 'bg-gray-900 text-white' : 'bg-white hover:bg-gray-100'
          }`}
          title="Strikethrough"
        >
          <s>S</s>
        ...
        <button
          ...
          className={`px-3 py-1 rounded ${
            editor.isActive('code') ? 'bg-gray-900 text-white' : 'bg-white hover:bg-gray-100'
          }`}
          title="Inline Code"
        >
          {'</>'}
        ...
        {[1, 2, 3].map((level) => (
          <button
            ...
            className={`px-3 py-1 rounded ${
              editor.isActive('heading', { level }) ? 'bg-gray-900 text-white' : 'bg-white hover:bg-gray-100'
            }`}
            title={`Heading ${level}`}
          >
            H{level}
        ...
        <button
          ...
          className={`px-3 py-1 rounded ${
            editor.isActive('taskList') ? 'bg-gray-900 text-white' : 'bg-white hover:bg-gray-100'
          }`}
          title="Task List"
        >
          ☑ Task
        ...
        <button
          ...
          className={`px-3 py-1 rounded ${
            editor.isActive('codeBlock') ? 'bg-gray-900 text-white' : 'bg-white hover:bg-gray-100'
          }`}
          title="Code Block"
        >
          {'<Code/>'}
        ...
        <button
          ...
          className={`px-3 py-1 rounded ${
            editor.isActive('blockquote') ? 'bg-gray-900 text-white' : 'bg-white hover:bg-gray-100'
          }`}
          title="Blockquote"
        >
          " Quote
        ...
        <button
          ...
          className={`px-3 py-1 rounded ${
            editor.isActive('link') ? 'bg-gray-900 text-white' : 'bg-white hover:bg-gray-100'
          }`}
          title="Add Link"
        >
          🔗 Link
