      ...
      <div className="tiptap-editor border border-gray-300 rounded-lg overflow-hidden">
        ...
        <div
          className={`flex flex-wrap ${
            isCompact ? "gap-0.5 p-1.5" : "gap-1.5 p-2.5"
        ...
        >
          ...
          <button
            ...
            className={`${
              isCompact ? "w-7 h-7 text-xs" : "w-9 h-9"
            } rounded-md flex items-center justify-center font-semibold transition-all shadow-sm ${
          ...
          <button
            ...
            className={`${
              isCompact ? "w-7 h-7 text-xs" : "w-9 h-9"
            } rounded-md flex items-center justify-center italic transition-all shadow-sm ${
          ...
          <button
            ...
            className={`${
              isCompact ? "w-7 h-7 text-xs" : "w-9 h-9"
            } rounded-md flex items-center justify-center line-through transition-all shadow-sm ${
          ...
          <button
            ...
            className={`${
              isCompact ? "w-7 h-7 text-xs" : "w-9 h-9"
            } rounded-md flex items-center justify-center font-mono text-sm transition-all shadow-sm ${
          ...
          {[1, 2, 3].map((level) => (
            <button
              ...
              className={`${
                isCompact ? "w-8 h-7 text-xs" : "px-3 py-1"
              } rounded ${
          ...
          <button
            ...
            className={`${
              isCompact ? "w-7 h-7 text-sm" : "px-3 py-1"
            } rounded ${
          ...
          <button
            ...
            className={`${
              isCompact ? "w-7 h-7 text-xs" : "px-3 py-1"
            } rounded ${
          ...
          <button
            ...
            className={`${
              isCompact ? "w-7 h-7 text-sm" : "px-3 py-1"
            } rounded bg-white hover:bg-gray-100`}
            title="Insert Table"
          >
            {isCompact ? "⊞" : "⊞ Table"}
          </button>
          {editor.isActive("table") && (
            <>
              <button
                ...
                } rounded bg-white hover:bg-gray-100 text-xs`}
                title="Add Column"
              >
                {isCompact ? "+C" : "+Col"}
              </button>
              ...
              <button
                ...
                className={`${
                  isCompact ? "w-7 h-7 text-xs" : "px-2 py-1"
                } rounded bg-white hover:bg-gray-100 text-xs`}
                title="Delete Table"
              >
                {isCompact ? "✕" : "✕Table"}
          ...
          <button
            ...
            className={`${
              isCompact ? "w-7 h-7 text-sm" : "px-3 py-1"
            } rounded bg-white hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed`}
            title="Undo (Ctrl+Z)"
          >
            ↶
          </button>
