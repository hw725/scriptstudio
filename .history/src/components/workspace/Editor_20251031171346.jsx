...
export default function Editor({
  ...
  return (
    <div className="h-full flex flex-col bg-white relative">
      ...
      <div className="h-10 px-3 border-b border-slate-200 flex items-center justify-between gap-3 flex-shrink-0 bg-white">
        <input
          type="text"
          value={title}
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              ...
              >
                ...
                <span className="hidden xl:inline text-xs">태그</span>
              </Button>
            </DropdownMenuTrigger>
            <DropdownMenuContent align="end" className="w-80 p-2">
              <div className="p-1">
                <TagInput tags={tags} onChange={setTags} disabled={isReadMode} />
              </div>
            </DropdownMenuContent>
          </DropdownMenu>
      ...
      {/* 상단 공간 절약을 위해 태그 입력전용 행을 제거하고, 상단 바의 태그 버튼 드롭다운으로 이동 */}
