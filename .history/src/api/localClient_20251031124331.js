...
export const localClient = {
  ...
  functions: {
    syncRefManager: async () => {
      ...
      return { success: true, message: "로컬 모드에서는 동기화가 필요하지 않습니다" };
    },
    syncVJOCR: async () => {
      console.log("🔤 로컬 모드 - syncVJOCR (실제 동작 없음)");
      return { success: true, message: "로컬 모드에서는 OCR이 지원되지 않습니다" };
    },
    syncPomoFlow: async () => {
      console.log("⏱️ 로컬 모드 - syncPomoFlow (실제 동작 없음)");
      return { success: true, message: "로컬 모드에서는 PomoFlow가 지원되지 않습니다" };
    },
    exportData: async () => {
      console.log("📤 로컬 모드 - exportData (실제 동작 없음)");
      return { success: true, message: "로컬 모드에서는 내보내기가 지원되지 않습니다" };
    },
  },
